...
Game_of_Rooms.add_room(Room.new("You are in a black room. ", "Weird room. There is a random pipe, a flex-capacitor, and a towel.b", {:N => 5, :S => 3}, ["pipe", "flex-capacitor" , "towel"]))
